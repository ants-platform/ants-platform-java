...
@JsonDeserialize(
    builder = CreateObservationEvent.Builder.class
)
public final class CreateObservationEvent implements IBaseEvent {
  ...
  private final ObservationBody body;

  private final Map<String, Object> additionalProperties;

  private CreateObservationEvent(String id, String timestamp, Optional<Object> metadata,
      ObservationBody body, Map<String, Object> additionalProperties) {
    this.id = id;
  ...
  /**
   * @return Optional. Metadata field used by the ANTS Platform SDKs for debugging.
   */
  ...
  @JsonProperty("body")
  public ObservationBody getBody() {
    return body;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof CreateObservationEvent && equalTo((CreateObservationEvent) other);
  }
  ...
  private boolean equalTo(CreateObservationEvent other) {
  ...
  public interface IdStage {
    ...
    Builder from(CreateObservationEvent other);
  }
  ...
  public interface BodyStage {
    _FinalStage body(@NotNull ObservationBody body);
  }

  public interface _FinalStage {
    CreateObservationEvent build();
  ...
  public static final class Builder implements IdStage, TimestampStage, BodyStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(CreateObservationEvent other) {
      id(other.getId());
    ...
    @java.lang.Override
    @JsonSetter("body")
    public _FinalStage body(@NotNull ObservationBody body) {
      this.body = Objects.requireNonNull(body, "body must not be null");
      return this;
    }

    /**
     * <p>Optional. Metadata field used by the ANTS Platform SDKs for debugging.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @java.lang.Override
    ...
    @java.lang.Override
    public CreateObservationEvent build() {
      return new CreateObservationEvent(id, timestamp, metadata, body, additionalProperties);
    }
  }
}
