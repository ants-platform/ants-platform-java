...
@JsonDeserialize(
    builder = BaseScoreV1.Builder.class
)
public final class BaseScoreV1 implements IBaseScoreV1 {
  ...
  private BaseScoreV1(String id, String traceId, String name, ScoreSource source,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof BaseScoreV1 && equalTo((BaseScoreV1) other);
  }
  ...
  private boolean equalTo(BaseScoreV1 other) {
  ...
  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.id, this.traceId, this.name, this.source, this.observationId, this.timestamp, this.createdAt, this.updatedAt, this.authorUserId, this.comment, this.metadata, this.configId, this.queueId, this.environment);
  }
  ...
  public interface IdStage {
    ...
    Builder from(BaseScoreV1 other);
  }
  ...
  public static final class Builder implements IdStage, TraceIdStage, NameStage, SourceStage, TimestampStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    private String id;
    ...
    @java.lang.Override
    public Builder from(BaseScoreV1 other) {
      id(other.getId());
    ...
    @java.lang.Override
    public BaseScoreV1 build() {
      return new BaseScoreV1(id, traceId, name, source, observationId, timestamp, createdAt, updatedAt, authorUserId, comment, metadata, configId, queueId, environment, additionalProperties);
    }
  }
}
