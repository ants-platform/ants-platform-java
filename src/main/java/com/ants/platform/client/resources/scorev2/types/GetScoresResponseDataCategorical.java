...
import com.ants.platform.client.resources.commons.types.ICategoricalScore;
...
public final class GetScoresResponseDataCategorical implements ICategoricalScore, IBaseScore {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GetScoresResponseDataCategorical && equalTo((GetScoresResponseDataCategorical) other);
  }
  ...
  public static final class Builder implements StringValueStage, IdStage, NameStage, SourceStage, TimestampStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(GetScoresResponseDataCategorical other) {
    ...
    @java.lang.Override
    public GetScoresResponseDataCategorical build() {
      return new GetScoresResponseDataCategorical(value, stringValue, id, traceId, sessionId, observationId, datasetRunId, name, source, timestamp, createdAt, updatedAt, authorUserId, comment, metadata, configId, queueId, environment, trace, additionalProperties);
    }
  }
}
