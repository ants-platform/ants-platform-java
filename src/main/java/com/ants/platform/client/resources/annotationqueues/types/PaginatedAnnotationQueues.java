...
package com.ants.platform.client.resources.annotationqueues.types;
...
@JsonDeserialize(
    builder = PaginatedAnnotationQueues.Builder.class
)
public final class PaginatedAnnotationQueues {
  private final List<AnnotationQueue> data;

  private final MetaResponse meta;

  private final Map<String, Object> additionalProperties;

  private PaginatedAnnotationQueues(List<AnnotationQueue> data, MetaResponse meta,
  ...
  @JsonProperty("data")
  public List<AnnotationQueue> getData() {
    return data;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PaginatedAnnotationQueues && equalTo((PaginatedAnnotationQueues) other);
  }
  ...
  private boolean equalTo(PaginatedAnnotationQueues other) {
  ...
  public interface MetaStage {
    ...
    Builder from(PaginatedAnnotationQueues other);
  }
  ...
  public interface _FinalStage {
    ...
    _FinalStage addAllData(List<AnnotationQueue> data);
  }
  ...
  public static final class Builder implements MetaStage, _FinalStage {
    ...
    private List<AnnotationQueue> data = new ArrayList<>();
    ...
    @java.lang.Override
    public Builder from(PaginatedAnnotationQueues other) {
      data(other.getData());
      meta(other.getMeta());
      return this;
    }
    ...
    @java.lang.Override
    public _FinalStage addData(AnnotationQueue data) {
      this.data.add(data);
      return this;
    }
