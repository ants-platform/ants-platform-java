...
public final class TraceWithFullDetails implements ITrace {
  ...
  /**
   * @return The environment from which this trace originated. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'ants-platform'.
   */
  ...
  /**
   * @return Path of trace in ANTS Platform UI
   */
  ...
  public static final class Builder implements IdStage, TimestampStage, HtmlPathStage, LatencyStage, TotalCostStage, _FinalStage {
    ...
    /**
     * <p>Path of trace in ANTS Platform UI</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @java.lang.Override
    @JsonSetter("htmlPath")
    ...
    /**
     * <p>The environment from which this trace originated. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'ants-platform'.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @java.lang.Override
