...
public final class Observation implements IObservation {
  ...
  /**
   * @return The environment from which this observation originated. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'ants-platform'.
   */
  ...
  public static final class Builder implements IdStage, TypeStage, StartTimeStage, LevelStage, _FinalStage {
    ...
    /**
     * <p>The environment from which this observation originated. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'ants-platform'.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @java.lang.Override
