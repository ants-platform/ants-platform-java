...
@JsonDeserialize(
    builder = BooleanScoreV1.Builder.class
)
public final class BooleanScoreV1 implements IBaseScoreV1 {
  ...
  private BooleanScoreV1(String id, String traceId, String name, ScoreSource source,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof BooleanScoreV1 && equalTo((BooleanScoreV1) other);
  }
  ...
  private boolean equalTo(BooleanScoreV1 other) {
  ...
  public static final class Builder implements IdStage, TraceIdStage, NameStage, SourceStage, TimestampStage, CreatedAtStage, UpdatedAtStage, ValueStage, StringValueStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(BooleanScoreV1 other) {
      id(other.getId());
    ...
    @java.lang.Override
    public BooleanScoreV1 build() {
      return new BooleanScoreV1(id, traceId, name, source, observationId, timestamp, createdAt, updatedAt, authorUserId, comment, metadata, configId, queueId, environment, value, stringValue, additionalProperties);
    }
  }
}
