...
package com.ants.platform.client.resources.commons.types;
...
public final class Model {
  ...
  private final boolean isAntsPlatformManaged;
  ...
  private Model(String id, String modelName, String matchPattern,
      ...
      Optional<String> tokenizerId, Optional<Object> tokenizerConfig, boolean isAntsPlatformManaged,
    ...
    this.isAntsPlatformManaged = isAntsPlatformManaged;
    this.prices = prices;
  ...
  @JsonProperty("isAntsPlatformManaged")
  public boolean getIsAntsPlatformManaged() {
    return isAntsPlatformManaged;
  }
  ...
  private boolean equalTo(Model other) {
    return id.equals(other.id) && modelName.equals(other.modelName) && matchPattern.equals(other.matchPattern) && startDate.equals(other.startDate) && unit.equals(other.unit) && inputPrice.equals(other.inputPrice) && outputPrice.equals(other.outputPrice) && totalPrice.equals(other.totalPrice) && tokenizerId.equals(other.tokenizerId) && tokenizerConfig.equals(other.tokenizerConfig) && isAntsPlatformManaged == other.isAntsPlatformManaged && prices.equals(other.prices);
  }

  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.id, this.modelName, this.matchPattern, this.startDate, this.unit, this.inputPrice, this.outputPrice, this.totalPrice, this.tokenizerId, this.tokenizerConfig, this.isAntsPlatformManaged, this.prices);
  }
  ...
  public interface MatchPatternStage {
    IsAntsPlatformManagedStage matchPattern(@NotNull String matchPattern);
  }

  public interface IsAntsPlatformManagedStage {
    _FinalStage isAntsPlatformManaged(boolean isAntsPlatformManaged);
  }
  ...
  public static final class Builder implements IdStage, ModelNameStage, MatchPatternStage, IsAntsPlatformManagedStage, _FinalStage {
    private String id;
    ...
    private boolean isAntsPlatformManaged;
    ...
    public Builder from(Model other) {
      ...
      isAntsPlatformManaged(other.getIsAntsPlatformManaged());
    ...
    public IsAntsPlatformManagedStage matchPattern(@NotNull String matchPattern) {
      this.matchPattern = Objects.requireNonNull(matchPattern, "matchPattern must not be null");
      return this;
    }

    @java.lang.Override
    @JsonSetter("isAntsPlatformManaged")
    public _FinalStage isAntsPlatformManaged(boolean isAntsPlatformManaged) {
      this.isAntsPlatformManaged = isAntsPlatformManaged;
      return this;
    }
    ...
    @java.lang.Override
    public Model build() {
      return new Model(id, modelName, matchPattern, startDate, unit, inputPrice, outputPrice, totalPrice, tokenizerId, tokenizerConfig, isAntsPlatformManaged, prices, additionalProperties);
    }
  }
}
