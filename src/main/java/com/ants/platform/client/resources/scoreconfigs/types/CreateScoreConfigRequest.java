...
package com.ants.platform.client.resources.scoreconfigs.types;
...
import com.ants.platform.client.resources.commons.types.ConfigCategory;
...
public final class CreateScoreConfigRequest {
  ...
  /**
   * @return Description is shown across the ANTS Platform UI and can be used to e.g. explain the config categories in detail, why a numeric range was set, or provide additional context on config name or usage
   */
  ...
  public static final class Builder implements NameStage, DataTypeStage, _FinalStage {
    ...
    /**
     * <p>Description is shown across the ANTS Platform UI and can be used to e.g. explain the config categories in detail, why a numeric range was set, or provide additional context on config name or usage</p>
