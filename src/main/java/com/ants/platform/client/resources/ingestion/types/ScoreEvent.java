...
@JsonDeserialize(
    builder = ScoreEvent.Builder.class
)
public final class ScoreEvent implements IBaseEvent {
  ...
  private final ScoreBody body;

  private final Map<String, Object> additionalProperties;

  private ScoreEvent(String id, String timestamp, Optional<Object> metadata, ScoreBody body,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ScoreEvent && equalTo((ScoreEvent) other);
  }
  ...
  private boolean equalTo(ScoreEvent other) {
  ...
  public interface BodyStage {
    _FinalStage body(@NotNull ScoreBody body);
  }
  ...
  public static final class Builder implements IdStage, TimestampStage, BodyStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(ScoreEvent other) {
      id(other.getId());
    ...
    @java.lang.Override
    @JsonSetter("body")
    public _FinalStage body(@NotNull ScoreBody body) {
    ...
    public ScoreEvent build() {
      return new ScoreEvent(id, timestamp, metadata, body, additionalProperties);
    }
  }
}
