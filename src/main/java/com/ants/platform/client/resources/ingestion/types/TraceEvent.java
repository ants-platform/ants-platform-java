...
@JsonDeserialize(
    builder = TraceEvent.Builder.class
)
public final class TraceEvent implements IBaseEvent {
  ...
  private TraceEvent(String id, String timestamp, Optional<Object> metadata, TraceBody body,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof TraceEvent && equalTo((TraceEvent) other);
  }
  ...
  private boolean equalTo(TraceEvent other) {
  ...
  public interface BodyStage {
    _FinalStage body(@NotNull TraceBody body);
  }
  ...
  public static final class Builder implements IdStage, TimestampStage, BodyStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(TraceEvent other) {
      id(other.getId());
    ...
    @java.lang.Override
    @JsonSetter("body")
    public _FinalStage body(@NotNull TraceBody body) {
    ...
    public TraceEvent build() {
      return new TraceEvent(id, timestamp, metadata, body, additionalProperties);
    }
  }
}
