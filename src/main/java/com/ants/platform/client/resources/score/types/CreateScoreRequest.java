...
package com.ants.platform.client.resources.score.types;
...
import com.ants.platform.client.resources.commons.types.CreateScoreValue;
import com.ants.platform.client.resources.commons.types.ScoreDataType;
...
public final class CreateScoreRequest {
  ...
  /**
   * @return The environment of the score. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'ants-platform'.
   */
  ...
  /**
   * @return Reference a score config on a score. The unique ANTS Platform identifier of a score config. When passing this field, the dataType and stringValue fields are automatically populated.
   */
  ...
  public static final class Builder implements NameStage, ValueStage, _FinalStage {
    ...
    /**
     * <p>Reference a score config on a score. The unique ANTS Platform identifier of a score config. When passing this field, the dataType and stringValue fields are automatically populated.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @java.lang.Override
    ...
    /**
     * <p>The environment of the score. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'ants-platform'.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @java.lang.Override
