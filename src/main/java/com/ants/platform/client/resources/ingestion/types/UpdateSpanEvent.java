...
@JsonDeserialize(
    builder = UpdateSpanEvent.Builder.class
)
public final class UpdateSpanEvent implements IBaseEvent {
  ...
  private final UpdateSpanBody body;

  private final Map<String, Object> additionalProperties;

  private UpdateSpanEvent(String id, String timestamp, Optional<Object> metadata,
      UpdateSpanBody body, Map<String, Object> additionalProperties) {
    this.id = id;
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof UpdateSpanEvent && equalTo((UpdateSpanEvent) other);
  }
  ...
  private boolean equalTo(UpdateSpanEvent other) {
  ...
  public interface IdStage {
    ...
    Builder from(UpdateSpanEvent other);
  }
  ...
  public interface BodyStage {
    _FinalStage body(@NotNull UpdateSpanBody body);
  }

  public interface _FinalStage {
    UpdateSpanEvent build();
  ...
  public static final class Builder implements IdStage, TimestampStage, BodyStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(UpdateSpanEvent other) {
      id(other.getId());
    ...
    @java.lang.Override
    @JsonSetter("body")
    public _FinalStage body(@NotNull UpdateSpanBody body) {
    ...
    @java.lang.Override
    public UpdateSpanEvent build() {
      return new UpdateSpanEvent(id, timestamp, metadata, body, additionalProperties);
    }
  }
}
