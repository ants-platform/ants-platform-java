...
package com.ants.platform.client.resources.scorev2.types;
...
import com.ants.platform.client.resources.commons.types.IBaseScore;
import com.ants.platform.client.resources.commons.types.IBooleanScore;
import com.ants.platform.client.resources.commons.types.ScoreSource;

@JsonInclude(JsonInclude.Include.NON_ABSENT)
@JsonDeserialize(
    builder = GetScoresResponseDataBoolean.Builder.class
)
public final class GetScoresResponseDataBoolean implements IBooleanScore, IBaseScore {
  ...
  private GetScoresResponseDataBoolean(double value, String stringValue, String id,
      ...
      Optional<String> comment, Optional<Object> metadata, Optional<String> configId,
      Optional<String> queueId, Optional<String> environment,
      Optional<GetScoresResponseTraceData> trace, Map<String, Object> additionalProperties) {
    this.value = value;
  ...
  /**
   * @return The environment from which this score originated. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'ants-platform'.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GetScoresResponseDataBoolean && equalTo((GetScoresResponseDataBoolean) other);
  }
  ...
  private boolean equalTo(GetScoresResponseDataBoolean other) {
  ...
  public interface ValueStage {
    ...
    Builder from(GetScoresResponseDataBoolean other);
  }
  ...
  public static final class Builder implements ValueStage, StringValueStage, IdStage, NameStage, SourceStage, TimestampStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(GetScoresResponseDataBoolean other) {
    ...
    /**
     * <p>The environment from which this score originated. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'ants-platform'.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @java.lang.Override
    ...
    public GetScoresResponseDataBoolean build() {
      return new GetScoresResponseDataBoolean(value, stringValue, id, traceId, sessionId, observationId, datasetRunId, name, source, timestamp, createdAt, updatedAt, authorUserId, comment, metadata, configId, queueId, environment, trace, additionalProperties);
    }
  }
}
