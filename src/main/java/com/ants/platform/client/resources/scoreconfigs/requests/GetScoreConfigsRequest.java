...
package com.ants.platform.client.resources.scoreconfigs.requests;
...
@JsonDeserialize(
    builder = GetScoreConfigsRequest.Builder.class
)
public final class GetScoreConfigsRequest {
  ...
  private GetScoreConfigsRequest(Optional<Integer> page, Optional<Integer> limit,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GetScoreConfigsRequest && equalTo((GetScoreConfigsRequest) other);
  }
  ...
  private boolean equalTo(GetScoreConfigsRequest other) {
  ...
  public static final class Builder {
    ...
    public Builder from(GetScoreConfigsRequest other) {
      page(other.getPage());
