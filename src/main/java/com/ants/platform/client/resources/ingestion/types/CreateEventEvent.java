...
@JsonDeserialize(
    builder = CreateEventEvent.Builder.class
)
public final class CreateEventEvent implements IBaseEvent {
  ...
  private final CreateEventBody body;

  private final Map<String, Object> additionalProperties;

  private CreateEventEvent(String id, String timestamp, Optional<Object> metadata,
      CreateEventBody body, Map<String, Object> additionalProperties) {
    this.id = id;
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof CreateEventEvent && equalTo((CreateEventEvent) other);
  }
  ...
  private boolean equalTo(CreateEventEvent other) {
  ...
  public interface BodyStage {
    _FinalStage body(@NotNull CreateEventBody body);
  }

  public interface _FinalStage {
    CreateEventEvent build();
  ...
  public static final class Builder implements IdStage, TimestampStage, BodyStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(CreateEventEvent other) {
      id(other.getId());
    ...
    @java.lang.Override
    @JsonSetter("body")
    public _FinalStage body(@NotNull CreateEventBody body) {
    ...
    @java.lang.Override
    public CreateEventEvent build() {
      return new CreateEventEvent(id, timestamp, metadata, body, additionalProperties);
    }
  }
}
