...
@JsonDeserialize(
    builder = UpdateObservationEvent.Builder.class
)
public final class UpdateObservationEvent implements IBaseEvent {
  ...
  private UpdateObservationEvent(String id, String timestamp, Optional<Object> metadata,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof UpdateObservationEvent && equalTo((UpdateObservationEvent) other);
  }
  ...
  private boolean equalTo(UpdateObservationEvent other) {
  ...
  public interface IdStage {
    ...
    Builder from(UpdateObservationEvent other);
  }
  ...
  public static final class Builder implements IdStage, TimestampStage, BodyStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(UpdateObservationEvent other) {
      id(other.getId());
    ...
    @java.lang.Override
    public UpdateObservationEvent build() {
      return new UpdateObservationEvent(id, timestamp, metadata, body, additionalProperties);
    }
  }
}
