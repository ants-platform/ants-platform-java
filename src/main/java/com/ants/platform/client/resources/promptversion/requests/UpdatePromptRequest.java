...
package com.ants.platform.client.resources.promptversion.requests;
...
public final class UpdatePromptRequest {
  ...
  /**
   * @return New labels for the prompt version. Labels are unique across versions. The &quot;latest&quot; label is reserved and managed by ANTS Platform.
   */
