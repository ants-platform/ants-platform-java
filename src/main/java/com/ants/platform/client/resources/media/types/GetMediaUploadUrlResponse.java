...
package com.ants.platform.client.resources.media.types;
...
public final class GetMediaUploadUrlResponse {
  ...
  /**
   * @return The unique ANTS Platform identifier of a media record
   */
  ...
  public static final class Builder implements MediaIdStage, _FinalStage {
    ...
    /**
     * <p>The unique ANTS Platform identifier of a media record</p>
